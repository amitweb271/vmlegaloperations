...
// // Lucide Icons import
// import {
//   Shield,            // For NDA Protected
//   Lock,              // For Confidential
//   Flag,              // For U.S. Focused
//   BarChart3,         // For Monthly Reports & Case Status Tracking
//   Clock,             // For Deadline Monitoring
//   Building2,         // For Court Monitoring
//   RefreshCw,         // For Follow-up & Coordination
//   FileText,          // For Weekly Status Reporting
//   CheckCircle2,      // For checkmarks
//   Target,            // For Our Role is Simple
//   Users,             // For Who We Support
//   Calendar,          // For Monthly Retainer
//   TestTube2,         // For Pilot Engagements
//   TrendingUp,        // For Scalable Pricing
//   Scale,             // Alternative for Legal/Justice
//   AlertCircle,       // For What We Don't Do
//   Zap                // For Ready to Streamline
// } from 'lucide-react';
...
//             {/* Trust Indicators - UPDATED WITH LUCIDE ICONS */}
//             <div style={{ 
...
//                   textAlign: isMobile ? 'center' : 'left'
//                 }}>
//                   <BarChart3 style={trustIconStyle} />
//                   <span className={styles.fontSemibold} style={{ 
//                     fontSize: isMobile ? '0.875rem' : '1rem',
//                     color: '#374151'
//                   }}>
...
//       {/* === WHAT WE DO SECTION - UPDATED ICONS === */}
...
//                   <CheckCircle2 style={{ color: '#10b981', marginRight: '0.5rem', marginTop: '0.25rem', width: '16px', height: '16px' }} />
...
//                   <CheckCircle2 style={{ color: '#1d4ed8', marginRight: '0.5rem', width: '16px', height: '16px' }} />
...
//       {/* === HOW WE WORK SECTION - UPDATED ICONS === */}
//       <section className={styles.section} style={{ 
//         padding: isMobile ? '3rem 0' : '5rem 0',
...
//       {/* === WHO WE SUPPORT SECTION - UPDATED ICONS === */}
...
//             marginRight: '0.75rem'
//           }} />
//           <h3 className={styles.heading3} style={{ color: 'white', fontSize: '1.25rem' }}>
//             Ideal Clients
//           </h3>
//         </div>
//         <ul style={{ listStyle: 'none', padding: 0 }}>
...
//               {/* Dot instead of CheckCircle2 icon */}
//               <div style={{ 
//                 backgroundColor: '#60a5fa', 
//                 width: '6px', 
//                 height: '6px', 
...
//       }}>
//         <div className={styles.flex} style={{ alignItems: 'center', marginBottom: '1rem' }}>
//           {/* Dot instead of AlertCircle icon */}
//           <div style={{ 
...
//       {/* === WHAT WE DON'T DO SECTION - UPDATED ICONS === */}
...
//       {/* === ENGAGEMENT MODEL SECTION - UPDATED ICONS === */}
//       <section className={`${styles.section} ${styles.sectionLight}`} style={{ padding: isMobile ? '3rem 0' : '5rem 0' }}>
//         <div className={styles.container}>
//           <div className={styles.textCenterMobile} style={{ marginBottom: isMobile ? '2rem' : '3rem' }}>
...
//       {/* === FINAL CTA SECTION - UPDATED ICONS === */}
//       <section className={styles.section} style={{ 
//         background: 'linear-gradient(135deg, #1d4ed8 0%, #1e40af 100%)', 
//         color: 'white',
  ...
  return (
    <div className={styles.premiumContainer}>
          ...
          <div className={styles.heroContent}>
            ...
            <div className={styles.taglineContainer}>
              <div className={styles.tagline}>
                <span className={styles.taglineText}>Clarity.</span>
                <span className={styles.taglineText}>Consistency.</span>
                <span className={styles.taglineText}>Control.</span>
              </div>
            </div>
            ...
            <h2 className={styles.subheading}>
              ...
              <span className={styles.gradientText}> for U.S. Law Firms</span>
            </h2>
            
            {/* Scope of Services Card */}
            <div className={styles.scopeCard}>
              <div className={styles.scopeHeader}>
                <Shield className={styles.scopeIcon} />
            ...
            <div className={styles.trustSection}>
              <p className={styles.trustTitle}>Trusted by U.S. law firms for:</p>
              <div className={styles.trustGrid}>
                <div className={styles.trustItem}>
                  <div className={styles.trustIconContainer}>
                    <Shield className={styles.trustIcon} />
                  </div>
                  <span className={styles.trustText}>NDA Protected</span>
                </div>
                ...
                <div className={styles.trustItem}>
                  ...
                  <span className={styles.trustText}>Confidential</span>
                </div>
                
                <div className={styles.trustItem}>
                  <div className={styles.trustIconContainer}>
                    <Flag className={styles.trustIcon} />
                  </div>
                  <span className={styles.trustText}>U.S. Focused</span>
                </div>
                
                <div className={styles.trustItem}>
                  <div className={styles.trustIconContainer}>
                    <BarChart3 className={styles.trustIcon} />
                  </div>
                  <span className={styles.trustText}>Monthly Reports</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.servicesGrid}>
            ...
            <div className={styles.serviceCard}>
              <div className={styles.serviceHeader}>
                ...
                <h3 className={styles.serviceTitle}>Deadline & Timeline Monitoring</h3>
              </div>
              <ul className={styles.serviceList}>
                <li className={styles.serviceListItem}>
                  <CheckCircle2 className={styles.listIcon} />
            ...
            <div className={styles.serviceCard}>
              <div className={styles.serviceHeader}>
                ...
                <h3 className={styles.serviceTitle}>Court Notification & Docket Monitoring</h3>
              </div>
              <ul className={styles.serviceList}>
                <li className={styles.serviceListItem}>
                  <CheckCircle2 className={styles.listIcon} />
            ...
            <div className={styles.serviceCard}>
              <div className={styles.serviceHeader}>
                <div className={styles.serviceIconContainer}>
                  <RefreshCw className={styles.serviceIcon} />
                </div>
                <h3 className={styles.serviceTitle}>Follow-Up & Coordination Support</h3>
              </div>
              <ul className={styles.serviceList}>
                <li className={styles.serviceListItem}>
                  <CheckCircle2 className={styles.listIcon} />
            ...
            <div className={styles.serviceCard}>
              <div className={styles.serviceHeader}>
                ...
                <h3 className={styles.serviceTitle}>Weekly Status Reporting</h3>
              </div>
      ...
      <section className={styles.sectionGray}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>About Our Approach</h2>
            <p className={styles.sectionDescription}>
              How we deliver reliable legal operations support
            </p>
          </div>
            ...
            <div className={styles.workContent}>
              <div className={styles.workList}>
                <div className={styles.workItem}>
                  <div className={styles.workIconContainer}>
                    <CheckCircle2 className={styles.workIcon} />
                  </div>
                  <div>
                    <h3 className={styles.workItemTitle}>Work Alongside Your Systems</h3>
                ...
                <div className={styles.workItem}>
                  <div className={styles.workIconContainer}>
                    <Shield className={styles.workIcon} />
                  </div>
                  <div>
                    <h3 className={styles.workItemTitle}>Secure Access</h3>
                    <p className={styles.workItemDescription}>
                      Access is always limited, role-based, and agreed in advance
                    </p>
                  </div>
                ...
                <div className={styles.workItem}>
                  <div className={styles.workIconContainer}>
                    <Lock className={styles.workIcon} />
                  </div>
                  <div>
                    <h3 className={styles.workItemTitle}>Confidentiality & NDA</h3>
                    <p className={styles.workItemDescription}>
                      We operate under strict confidentiality and NDA protections
                    </p>
                  </div>
                ...
                <div className={styles.workItem}>
                  <div className={styles.workIconContainer}>
                    <TestTube2 className={styles.workIcon} />
                  </div>
                  <div>
                    <h3 className={styles.workItemTitle}>Start with Pilot</h3>
                    <p className={styles.workItemDescription}>
                      Engagements typically begin with a small pilot before scaling
                    </p>
                  </div>
              ...
              <div className={styles.roleCard}>
                ...
                <h3 className={styles.roleTitle}>Our Role is Simple</h3>
                <p className={styles.roleDescription}>
                  To provide consistency, visibility, and operational discipline.
                </p>
                <Link href="/how-we-work" className={styles.roleButton}>
                  Learn More
                  <ChevronRight className={styles.buttonIcon} />
                </Link>
              </div>
      ...
      <section className={styles.sectionDark}>
        <div className={styles.container}>
          <div className={styles.sectionHeader}>
            <h2 className={`${styles.sectionTitle} ${styles.textWhite}`}>Who We Support</h2>
          </div>
          ...
          <div className={styles.supportGrid}>
            <div className={styles.supportCard}>
              <div className={styles.supportHeader}>
                ...
                <h3 className={styles.supportTitle}>Ideal Clients</h3>
              </div>
              <ul className={styles.supportList}>
                {[
                  ...
                  <li key={idx} className={styles.supportListItem}>
            ...
            <div className={styles.supportCard}>
              <div className={styles.supportHeader}>
                <div className={styles.supportDotYellow}></div>
                <h3 className={styles.supportTitle}>Why Legal Operations Support Matters</h3>
              </div>
              ...
              <ul className={styles.supportList}>
                {[
                  ...
                  <li key={idx} className={styles.supportListItem}>
                    <div className={styles.listDotYellow}></div>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
              <p className={styles.supportHighlight}>
                We help address these gaps by owning the tracking and reporting process, 
                so attorneys can focus on substantive legal work.
              </p>
            </div>
          ...
          <div className={styles.centerButton}>
            <Link href="/who-we-support" className={styles.outlineButton}>
              View Details
              <ChevronRight className={styles.buttonIcon} />
            </Link>
          </div>
      ...
      <section className={styles.sectionWhite}>
        <div className={styles.container}>
          ...
          <div className={styles.notDoGrid}>
            <div className={styles.notDoCard}>
              <div className={styles.notDoHeader}>
                <div className={styles.notDoIconContainer}>
                  <Scale className={styles.notDoIcon} />
                </div>
                <h3 className={styles.notDoTitle}>Legal Advice & Representation</h3>
              </div>
              <p className={styles.notDoDescription}>
                We do not provide legal advice, draft pleadings or legal opinions, 
                or represent clients before any court or authority.
              </p>
            </div>
            ...
            <div className={styles.notDoCard}>
              <div className={styles.notDoHeader}>
                <div className={styles.notDoIconContainer}>
                  <AlertCircle className={styles.notDoIcon} />
                </div>
                <h3 className={styles.notDoTitle}>Legal Decision Making</h3>
              </div>
              <p className={styles.notDoDescription}>
                We do not make legal or strategic decisions, nor do we access 
                trust accounts or billing systems.
          ...
          <div className={styles.noteCard}>
            ...
            <div className={styles.noteButton}>
              <Link href="/what-we-dont-do" className={styles.outlineButtonDark}>
                Full Service Exclusions
                <ChevronRight className={styles.buttonIcon} />
              </Link>
            </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.engagementGrid}>
            <div className={styles.engagementCard}>
              <div className={styles.engagementIconContainer}>
                <Calendar className={styles.engagementIcon} />
              </div>
              <h3 className={styles.engagementTitle}>Monthly Retainer</h3>
            ...
            <div className={styles.engagementCard}>
              <div className={styles.engagementIconContainer}>
                <TestTube2 className={styles.engagementIcon} />
              </div>
              <h3 className={styles.engagementTitle}>Pilot Engagements</h3>
              <p className={styles.engagementDescription}>
                Start small to evaluate our services with minimal commitment
              </p>
            </div>
            ...
            <div className={styles.engagementCard}>
              <div className={styles.engagementIconContainer}>
                <TrendingUp className={styles.engagementIcon} />
              </div>
              <h3 className={styles.engagementTitle}>Scalable Pricing</h3>
              <p className={styles.engagementDescription}>
                Pricing structured to be predictable and scalable based on case volume
              </p>
            </div>
          ...
          <div className={styles.scopeCardBlue}>
